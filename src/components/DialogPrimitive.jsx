  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="data-[state=open]:animate-contentShow fixed left-[50%] top-[50%] max-h-[85vh] w-120 translate-x-[-50%] translate-y-[-50%] overflow-auto rounded-md bg-white p-8 focus:outline-none">
